...
<<<<<<< HEAD
	 ...
	 * @ResponseBody
	 * 
	 * @RequestMapping(value="/reviewLikeInsert.do", produces =
	 * "application/json;charset=utf-8") public String reviewLikeInsert(int
	 * reviewCommentNo, String memberId) { int result = service.reviewLikeInsert();
	 * return memberId;
	 * 
	 * }
	 */
