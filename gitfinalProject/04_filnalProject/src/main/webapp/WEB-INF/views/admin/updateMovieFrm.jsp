                                    ...
                                    <form action="/updateMovie.do" method="post" enctype="multipart/form-data"
                                        ...
                                        <div class="form-group my-2">
                                            ...
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <input type="checkbox" class="form-check-input my-1"
                                                        id="filmSociety" name="filmSociety" value="N">
                                                </c:otherwise>
                                            </c:choose>
                                            ...
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <input type="checkbox" class="form-check-input my-1"
                                                        id="classicSociety" name="classicSociety" value="N">
                                                </c:otherwise>
                                            </c:choose>
                                            ...
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <input type="checkbox" class="form-check-input my-1"
                                                        id="specialMovie" name="specialMovie" value="N">
                                                </c:otherwise>
                                            </c:choose>
                                        </div>
                                        <div class="form-group my-2">
                                            ...
                                            <div class="input-group mb-3">
                                                <div class="input-group w-50">
                                                    <label class="input-group-text" for="movieMain">메인
                                                        이미지</label>
                                                    <input type="file" class="form-control" id="movieMain"
                                                        name="movieMain" aria-describedby="inputGroupFileAddon04"
                                                        aria-label="Upload">
                                                    <!-- Button trigger modal -->
                                                    <button type="button" class="btn btn-outline-secondary"
                                        ...
                                        <div class="form-group" class="my-2">
                                            <div class="input-group w-50">
                                                <label class="input-group-text" for="moviePoster">포스터
                                                    이미지</label>
                                                <input type="file" class="form-control" id="moviePoster"
                                                    name="moviePoster" aria-describedby="inputGroupFileAddon04"
