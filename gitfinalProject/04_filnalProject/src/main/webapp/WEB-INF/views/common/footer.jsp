...
<footer id="mega_footer">
    <div class="wrap ft_color">
        ...
        <ul class="footer_menu">
            ...
            <li>제휴/광고/부대사업 문의</li>
            <li>이용약관</li>
            <li><a href="http://www.megabox.co.kr/?menuId=privacy" target="_blank">개인정보 처리방침</a></li>
            <li>고객센터</li>
            <li>윤리경영</li>
        </ul>
        <div class="text1">
        ...
        <div class="logo_copy">
            ...
            <div class="text2">Copyright&copy; 2019 by <a href="#" target="_blank">LEEMEENHO</a> portpolio</div>
        </div>
        <!--logo copy-->
    </div>
    <!--wrap-->
