...
<link rel="stylesheet" href="/resources/css/ticketing/common2.css" />
<style>
	.oneMovie {
					position: relative;
...
<body>
	...
	<div class="all-wrap" style="margin:0 auto; width:1000px; height:1000px;">
		<div class="container" style="width: 1000px; margin-top:100px;">
			<div class="row mb-3">
				<div class="col">
					<h1 style="font-size:30px;">빠른 예매</h1>
				</div>
			</div>
			<div class="col-10">
				<div class="my-box">
					...
					<div class="movie-container">
							...
							<div class="movie-list">
								<c:choose>
										...
										<c:forEach var="movie" items="${movies}">
											<button class="movie-button" type="button"
												...
												<img src="${movie.ratingImageURL} "
													alt="${movie.ratingName}" /> <span class="txt">${movie.movieName}</span>
												<img src="/resources/images/btn/ico-heart.png" alt="heart"
													class="buttonicon">
											</button>
										</c:forEach>
										 -->
									...
									<c:otherwise>
										<c:forEach var="movie" items="${movies}">
											<button
												class="movie-button ${movie.movieNo eq param.no ? 'active' : '' }"
						...
						<div class="center-one">
								...
								<div class="all-theater-list">
									<div class="explain-button">
										...
										<c:forEach var="region" items="${regions }">
											<button class='list-theater-button'
												data-region='${region.no }' style="display: none">${region.name }</button>
										</c:forEach>
									</div>
								</div>
							...
							<div class="theater-choies-check">
								<p class="check-content" style="display: flex;">
									전체극장<br> 목록에서 극장을 선택하세요
								</p>
